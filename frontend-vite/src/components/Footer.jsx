...
const Footer = () => {
  return (
    <div className="w-full max-w-5/6 mt-8 mx-auto flex justify-center items-center font-montserrat relative bottom-0 left-0 right-0 z-10">
      ...
      <div className="bg-white/30 backdrop-blur-lg border border-white/20 rounded-2xl shadow-lg z-10 w-full px-5 py-3 flex justify-center items-center text-xs sm:text-sm md:text-sm text-white font-semibold text-center">
